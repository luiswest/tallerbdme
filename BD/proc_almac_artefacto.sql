...
DROP PROCEDURE IF EXISTS todosArtefacto$$
CREATE PROCEDURE todosArtefacto (_pagina SMALLINT UNSIGNED, _cantRegs SMALLINT UNSIGNED)
begin
    select * from artefacto limit _pagina, _cantRegs;
end$$
